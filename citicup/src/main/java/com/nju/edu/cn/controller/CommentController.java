...
public class CommentController {
    ...
    @GetMapping("/pageNum")
    public Integer getTotalCommentNum(@RequestParam("contractId") Long contractId) {
        logger.info("getTotalCommentNum, contractId:{}", contractId);
        return commentService.getPageNum(contractId);
    }
}
